...
import destr, { destr as destr$1 } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/rlong/Sandbox/aetherlink/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///home/rlong/Sandbox/aetherlink/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/rlong/Sandbox/aetherlink/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/rlong/Sandbox/aetherlink","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/rlong/Sandbox/aetherlink/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/rlong/Sandbox/aetherlink/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/rlong/Sandbox/aetherlink/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/rlong/Sandbox/aetherlink/.data/kv"}));
...
const _5if70uEOiw5qiBi1XpMrwMpt7n_UarHc7zu91MzWiMw = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/rlong/Sandbox/aetherlink";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Monitor your home wireless network with real-time device tracking and analytics"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Aetherlink - Network Monitor"};
...
const _sQt388jwNz1AbZSnIIXQxkEoETMXXi7ouAQAsVjno = (nitroApp) => {
...
const plugins = [
  _5if70uEOiw5qiBi1XpMrwMpt7n_UarHc7zu91MzWiMw,
...
const _ysSFGC = eventHandler((event) => {
...
const getServerEntry = () => import('file:///home/rlong/Sandbox/aetherlink/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///home/rlong/Sandbox/aetherlink/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_ay6lfG = () => Promise.resolve().then(function () { return status$1; });
const _lazy_dswqdt = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _ysSFGC, lazy: false, middleware: true, method: undefined },
  { route: '/api/network/status', handler: _lazy_ay6lfG, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_dswqdt, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_dswqdt, lazy: true, middleware: false, method: undefined }
];
